...
namespace OculusSampleFramework
{
	public class HandsManager : MonoBehaviour
	{
		...
		[SerializeField] private VisualDebuggerTool _visualDebugger;
		...
		{
			_visualDebugger.AssignTextC($"right hand mesh. {RightHandMesh} is initialized {RightHandMesh.IsInitialized}");
			_visualDebugger.AssignTextD($"left hand skel. {LeftHandSkeleton} is initialized {LeftHandSkeleton.IsInitialized}");
			_visualDebugger.AssignTextE($"right hand skel. {RightHandSkeleton} is initialized {RightHandSkeleton.IsInitialized}");
			_visualDebugger.AssignTextF($"left hand mesh. {LeftHandMesh} is initialized {LeftHandMesh.IsInitialized}");
